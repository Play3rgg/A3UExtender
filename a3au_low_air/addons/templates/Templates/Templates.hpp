class Templates 
{
    ...
    {
        basepath = QPATHTOFOLDER(Templates\Vanilla); //the path to the template folder
    };
    ...
    {
        name = "A3 CSAT&AAF";
        flagTexture = QPATHTOFOLDER(Templates\Vanilla\flags\CSAT_AAF.paa);
    ...
    {
        name = "A3 NATO&AAF";
        flagTexture = QPATHTOFOLDER(Templates\Vanilla\flags\NATO_AAF.paa);
    ...
    {
        side = "Occ";
        flagTexture = QPATHTOFOLDER(Templates\Vanilla\flags\NATO_LDF.paa);
